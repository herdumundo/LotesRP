 <form id="formulario_reporte_reproceso" name="formulario_reporte_reproceso" action="controles/control_reporte_reproceso_tradicional.jsp" target="_blank">
         <input type="hidden" id="tipo" name="tipo" value="PI">

     <div class="form-control bg-info" style="font-weight: bold;color:black;"><center> GENERACION DE REPORTES AVIARIOS TRADICIONALES SUBPRODUCTOS.</center></div>  
     <br>
